...
<body id="page-top" style="background-color: beige;">
    <div id="wrapper" style="background: var(--bs-light);">
        ...
        ?>
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion p-0" style="background-color:#000000;">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    <div class="sidebar-brand-icon " style="color:beige;"><img src="../assets/img/logo/1128.jpg" class=" w-100 img-fluid " style="height: 90px;"></div>
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="?title=home"><i class="fa fa-tachometer"></i><span>Dashboard</span></a></li>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="ProductDropdownCat" class="collapse" aria-labelledby="ProductDropdown" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <li class="nav-item">
                        ...
                        <div id="inventory" class="collapse" aria-labelledby="inventory" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
        ...
        <div class="d-flex flex-column " id="content-wrapper" style="background-color:beige;">
            ...
            <nav class="navbar navbar-dark navbar-expand shadow mb-4 topbar static-top"style="background-color:#000000;">
            <div class="container-fluid"><button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle me-3" type="button"><i class="fas fa-bars text-light"></i></button></div>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <div class="nav-item dropdown no-arrow">
                                <a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#">
                                    <span class="d-none d-lg-inline me-2 text-light small" ><?php echo $row_a['lastName']; ?></span>
                                    <img class="border rounded-circle img-profile" src="assets/img/avatars/avatar5.jpeg" />
                                </a>
                                <div class="dropdown-menu shadow dropdown-menu-end animated--grow-in">
                                    <a class="dropdown-item" href="../index.php"><i class="fas fa-sign-out-alt fa-sm fa-fw me-2 text-gray-400"></i> Logout</a>
                                </div>
                            </div>
                        </li>
                    </ul>
            ...
            <div id="content" style="color: var(--bs-dark);">
                <div class="container-fluid">
                    ...
                    <div class="col-md-12 col-xl-6 mb-4">
                            <div class="card shadow border-start-success py-2"style="background-color:#7d5110;">
                                <div class="card-body"><a href="?title=order&status=0" style="text-decoration: none;">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class=" fw-bold h5 mb-0" style="color:white ;" ><span id="ticket"><?php echo $newcount;?></span><span>&nbsp; &nbsp;New Order/s</span></div>
                                        </div>
                                        <div class="col-auto" style="color:white ;"><i  class="fas fa-hamburger fa-2x"></i></div>
                                    </div>
                                </div>
                            </div>
                        </div></a>
                        <div class="col-md-12 col-xl-6 mb-4">
                            <div class="card shadow border-start-success py-2"style="background-color:#7d5110;">
                                <div class="card-body"><a href="?title=order" style="text-decoration: none;">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class=" fw-bold h5 mb-0" style="color:white ;" ><span id="ticket"><?php echo $tcount;?></span><span>&nbsp; &nbsp; Order/s</span></div>
                                        </div>
                                        <div class="col-auto" style="color:white ;"><i  class="fas fa-glass fa-2x"></i></div>
                                    </div>
                                </div>
                            </div>
                        </div></a>
                        <div class="col-md-12 col-xl-6 mb-4">
                            <div class="card shadow border-start-success py-2" style="background-color:#7d5110;">
                                <div class="card-body"><a href="?title=product" style="text-decoration: none;">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class=" fw-bold h5 mb-0"  style="color:white ;" ><span id="productno"><?php echo $mcount;?></span><span>&nbsp; &nbsp; Product/s&nbsp;</span></div>
                                        </div>
                                        <div class="col-auto" style="color:white ;"><i class="fas fa-coffee fa-2x "></i></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="content">
                        <div class="container-fluid p-0">
                            ...
                            <div class="card border-0">
                                <div class="card-header border-0 py-3 "style="background-color:#7d5110;" >
                                    <div class="row">
                                ...
                                <div class="card-body " style="background-color:white;">
                                    <div class="table-responsive-sm " id="">
                                        <table class="table table-sm table-hover table-light table-striped table-bordered" id="userTable" height="100%"width="100%" cellspacing="0">
                                     <?php
