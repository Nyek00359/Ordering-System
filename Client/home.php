                ...
                <div class="container-fluid ">
                    <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                        <div class="sidebar-brand-icon " style="color:whitesmoke;"><img
                                src="../assets/img/logo/1128.jpg" class=" w-100 img-fluid " style="height:70px;"></div>
                    </a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        while ($row = $getcat->fetch_assoc()) {
                            ...
                            <div class="card text-nowrap shadow border-start-primary py-2" style="background-color:#7d5110;">
                                <div class="card-body">
