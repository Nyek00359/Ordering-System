    ...
    <div id="content">
            ...
            <form class="modal" method="post">
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-select size-selector" id="size">
                        ...
                        <option value="MediumOnly">Medium Only</option>
                        <option value="LargeOnly">Large Only</option>
                    </select>
                </div>
                ...
                <input type="submit" class="btn btn-coffee mx-auto d-block w-75" name="Create">
            </form>
        </div>
        <!-- Delete Form-->
        <div class="form-container p-3 delete-form" style="display: none;">
            <form class="modal" method="post">
                ...
                <input type="submit" class="btn btn-coffee mx-auto d-block w-75" name="Delete">
            </form>
        </div>
        <!-- Edit Form-->
        <div class="form-container p-3 edit-form" style="display: none;">
            <form class="modal" method="post">
                ...
                <input type="submit" class="btn btn-coffee mx-auto d-block w-75" name="Edit">
            </form>
        </div>
    </div>
</div>
