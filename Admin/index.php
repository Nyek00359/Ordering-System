    ...
    <div id="wrapper" style="background: var(--bs-light);">
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion p-0"
            ...
            <div class="container-fluid d-flex flex-column p-0"><a
                    ...
                    <div class="sidebar-brand-icon " style="color:beige;"><img src="../assets/img/logo/1128.jpg"
                        ...
                        if ($_GET["title"] == "home") { ?>
                            <div class="row">
                                <div class="col-md-6 col-xl-4 mb-4">
                                    <div class="card shadow border-start-primary py-2" style="background-color:#7d5110;">
                                ...
                                <div class="col-md-6 col-xl-4 mb-4">
                                    <div class="card shadow border-start-success py-2" style="background-color:#7d5110;">
                                        <div class="card-body"><a href="?title=order&status=3" style="text-decoration: none;">
                                                <div class="row align-items-center no-gutters">
                                                    <div class="col me-2">
                                                        <div class=" fw-bold h5 mb-0" style="color:white ;"><span id="order&status=3">
                                                                <?php echo $tcount; ?>
